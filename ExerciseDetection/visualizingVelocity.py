...
def draw(velocity):	
	...
	newDir = "C:\\Users\\Admin\\BlakeDeepak\\CMU_HCII_REU\\ExerciseDetection\\Visualization"
	...
	for i in range (0, int(numberTests)):
		...
		newDir2 = "C:\\Users\\Admin\\BlakeDeepak\\CMU_HCII_REU\\ExerciseDetection\\Visualization\\test" + str(i)
	...
	if not (os.path.exists(dirname +"\\Visualization\\Y\\")):
		os.makedirs(dirname +"\\Visualization\\Y\\")
	for b in range (0, 25):
		width = .99
		plt.bar(YDataX, YVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Y\\Bodypart" + str(b) + ".png")
		plt.close()
	
	if not (os.path.exists(dirname +"\\Visualization\\Seated\\")):
		os.makedirs(dirname +"\\Visualization\\Seated\\")
	for b in range (0, 25):
		width = .99
		plt.bar(SeatedDataX, SeatedVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Seated\\Bodypart" + str(b) + ".png")
		plt.close()

	if not (os.path.exists(dirname +"\\Visualization\\Sumo\\")):
		os.makedirs(dirname +"\\Visualization\\Sumo\\")
	for b in range (0, 25):
		width = .99
		plt.bar(SumoDataX, SumoVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Sumo\\Bodypart" + str(b) + ".png")
		plt.close()

	if not (os.path.exists(dirname +"\\Visualization\\Mermaid\\")):
		os.makedirs(dirname +"\\Visualization\\Mermaid\\")
	for b in range (0, 25):
		width = .99
		plt.bar(MermaidDataX, MermaidVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Mermaid\\Bodypart" + str(b) + ".png")
		plt.close()
	
	if not (os.path.exists(dirname +"\\Visualization\\Towel\\")):
		os.makedirs(dirname +"\\Visualization\\Towel\\")
	for b in range (0, 25):
		width = .99
		plt.bar(TowelDataX, TowelVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Towel\\Bodypart" + str(b) + ".png")
		plt.close()

	if not (os.path.exists(dirname +"\\Visualization\\Wall\\")):
		os.makedirs(dirname +"\\Visualization\\Wall\\")
	for b in range (0, 25):
		width = .99
		plt.bar(WallDataX, WallVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\Wall\\Bodypart" + str(b) + ".png")
		plt.close()

	if not (os.path.exists(dirname +"\\Visualization\\OOV\\")):
		os.makedirs(dirname +"\\Visualization\\OOV\\")
	for b in range (0, 25):
		width = .99
		plt.bar(OOVDataX, OOVVelocityGraph[b], width, facecolor='blue')
		plt.savefig(dirname +"\\Visualization\\OOV\\Bodypart" + str(b) + ".png")
		plt.close()
