...
def stdPersonXYZ(data, numberOfTests, timeScores):
	...
	newDir = "C:\\Users\\Admin\\BlakeDeepak\\CMU_HCII_REU\\ExerciseDetection\\stdData"
...
def copyLabels():
	for i in range (0, int(numberTests)):
		...
		resultsFileL = open("C:\\Users\\Admin\\BlakeDeepak\\CMU_HCII_REU\\ExerciseDetection\\stdData\\test" + str(i) +"\\label.csv", "a+")
