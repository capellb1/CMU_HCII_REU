...
#each event is a single row = All time stamps of a single bodypart in a row, append to the row for each body part
#[Arm1xyz, Arm2xyz... Head1xyz, Head2xyz... Foot1xyz, Foot2xyz]
...
def main(argv = None):
	...
	with tf.Session() as sess:
		...
		resultsFile.write("Validation Accuracy:" + str(accuracy.eval({X: testData, Y: testLabels})) + '\n')	
