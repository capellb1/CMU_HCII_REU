...
A variant of the base exerc. detector file that is set up in a binary fashion. This program only detects the seated and towel 
exercises. Was used in an attempt to establish a ROC curve for the model.
'''
...
def main(argv = None):
	...
	with tf.Session() as sess:
		...
		print("Final Testing Accuracy:", "{0:.2%}".format(accuracy2.eval({X: testData, Y: testLabels})))	
